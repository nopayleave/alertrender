                  ...
                  <div id="stochDirFilters" class="filter-content">
                    ...
                    <div class="mb-4">
                      <div class="flex items-center justify-between mb-2 px-1">
                        <label class="block text-xs font-medium text-muted-foreground">K1 <span id="stochK1ValueMinValue" class="text-amber-400 font-semibold">0</span> <span class="text-foreground/60">-</span> <span id="stochK1ValueMaxValue" class="text-amber-400 font-semibold">100</span></label>
                    ...
                    <div class="mb-4">
                      <div class="flex items-center justify-between mb-2 px-1">
                        <label class="block text-xs font-medium text-muted-foreground">K2 <span id="stochK2ValueMinValue" class="text-amber-400 font-semibold">0</span> <span class="text-foreground/60">-</span> <span id="stochK2ValueMaxValue" class="text-amber-400 font-semibold">100</span></label>
                        <div class="flex items-center gap-3">
                    ...
                    <div class="mb-4">
                      <div class="flex items-center justify-between mb-2 px-1">
                        <label class="block text-xs font-medium text-muted-foreground">K3 <span id="stochK3ValueMinValue" class="text-amber-400 font-semibold">0</span> <span class="text-foreground/60">-</span> <span id="stochK3ValueMaxValue" class="text-amber-400 font-semibold">100</span></label>
                        <div class="flex items-center gap-3">
